//
//  StarWarFilmRemoteDataSource.swift
//  SWAPIApp
//
...
class StarWarFilmRemoteDataSource: StarWarFilmDataSource {
    
    func fetchFilmDetails(havingId id: String) -> Observable<StarWarFilmModel> {
        
        return Observable<StarWarFilmModel>.create { (observer) -> Disposable in
            
            let apiEndPoint = StarWarAPIEndPoint.filmDetails(id: id)
            ...
            request.responseJSON { (response) in
                    ...
                    case .success(let result):
                        ...
                        case 200:
                            ...
                            guard let characterListModel = Mapper<StarWarFilmModel>().map(JSONObject: result) else {
